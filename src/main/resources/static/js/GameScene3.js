class GameScene3 extends Phaser.Scene {
    ...
    addCactus1() {
        ...
        this.physics.add.overlap(this.cactusGroup1, this.player1, this.hitCactusPlayer3, null, this); //overlap으로 선인장과 캐릭터가 충돌되면 hitCactusPlayer을 띄어줘라
    }
    ...
    addCactus2() {
        ...
        this.physics.add.overlap(this.cactusGroup2, this.player2, this.hitCactusPlayer2, null, this); //overlap으로 선인장과 캐릭터가 충돌되면 hitCactusPlayer을 띄어줘라
    }
    ...
    addCactus3() {
        ...
        this.physics.add.overlap(this.cactusGroup3, this.player3, this.hitCactusPlayer1, null, this); //overlap으로 선인장과 캐릭터가 충돌되면 hitCactusPlayer을 띄어줘라
    }
